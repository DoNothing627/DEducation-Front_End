...
export const hustBanner = "/assets/images/hust-banner.png";
export const harvardBanner = "/assets/images/harvard-banner.png";
export const stanfordBanner = "/assets/images/stanford-banner.png";
export const mitBanner = "/assets/images/mit-banner.png";
export const cambridgeBanner = "/assets/images/cambridge-banner.png";
