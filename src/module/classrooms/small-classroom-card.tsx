...
import "./small-classroom-card.scss";

export function SmallClassroomCard(props: GetMyClassroomResponseDTO) {
  ...
  return (
    <>
      <div className="small-classroom-card" onClick={onHandleClickClassroom}>
